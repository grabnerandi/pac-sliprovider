...
RUN GOOS=linux go build -ldflags '-linkmode=external' $BUILDFLAGS -v -o pac-sliprovider
...
COPY --from=builder /src/pac-sliprovider/pac-sliprovider /pac-sliprovider
